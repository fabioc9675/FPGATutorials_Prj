...
-- ldbanno -n VHDL -o MigenBlinkLed_MigenBlinkLed_vho.vho -w -neg -gui MigenBlinkLed_MigenBlinkLed.ncd 
-- Netlist created on Sat Jul 31 10:37:36 2021
-- Netlist written on Sat Jul 31 10:37:49 2021
...
-- entity ccu20002
  ...
  begin
    inst1: CCU2D
      generic map (INIT0 => X"5555", INIT1 => X"3333", INJECT1_0 => "NO", 
                   INJECT1_1 => "NO")
      port map (CIN=>CI, A0=>A0, B0=>B0, C0=>C0, D0=>D0, A1=>A1, B1=>B1, 
                C1=>C1, D1=>D1, S0=>S0, S1=>S1, COUT=>CO1);
  end Structure;
...
-- entity ccu20003
  ...
  begin
    inst1: CCU2D
      generic map (INIT0 => X"3333", INIT1 => X"5555", INJECT1_0 => "NO", 
                   INJECT1_1 => "NO")
      port map (CIN=>CI, A0=>A0, B0=>B0, C0=>C0, D0=>D0, A1=>A1, B1=>B1, 
                C1=>C1, D1=>D1, S0=>S0, S1=>S1, COUT=>CO1);
  end Structure;
...
-- entity SLICE_6
  ...
  begin
    ...
    VitalBehavior : PROCESS (A1_ipd, B0_ipd, DI1_dly, LSR_dly, CLK_dly, 
      FCI_ipd, F0_out, F1_out, Q1_out, FCO_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
    VARIABLE F1_zd         	: std_logic := 'X';
...
-- entity ccu20004
  ...
  begin
    inst1: CCU2D
      generic map (INIT0 => X"3333", INIT1 => X"3333", INJECT1_0 => "NO", 
                   INJECT1_1 => "NO")
      port map (CIN=>CI, A0=>A0, B0=>B0, C0=>C0, D0=>D0, A1=>A1, B1=>B1, 
                C1=>C1, D1=>D1, S0=>S0, S1=>S1, COUT=>CO1);
  end Structure;
...
-- entity SLICE_13
  ...
  begin
    ...
    VitalBehavior : PROCESS (D1_ipd, B1_ipd, D0_ipd, C0_ipd, DI1_dly, DI0_dly, 
      LSR_dly, CLK_dly, F0_out, Q0_out, F1_out, Q1_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
    VARIABLE Q0_zd         	: std_logic := 'X';
...
-- entity SLICE_14
  ...
  begin
    ...
    VitalBehavior : PROCESS (D1_ipd, C1_ipd, D0_ipd, C0_ipd, DI1_dly, DI0_dly, 
      LSR_dly, CLK_dly, F0_out, Q0_out, F1_out, Q1_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
    VARIABLE Q0_zd         	: std_logic := 'X';
...
-- entity top
  ...
  begin
    ...
    SLICE_2I: SLICE_2
      port map (B1=>counter_20, A0=>counter_19, FCI=>n256, F0=>n16, F1=>n15, 
                FCO=>n257);
    SLICE_3I: SLICE_3
      port map (A1=>counter_18, A0=>counter_17, DI1=>n17, LSR=>n235, 
                ...
                FCO=>n256);
    SLICE_4I: SLICE_4
      port map (A1=>counter_16, B0=>counter_15, FCI=>n254, F0=>n20, F1=>n19, 
                FCO=>n255);
    SLICE_5I: SLICE_5
    ...
    SLICE_6I: SLICE_6
      port map (A1=>counter_12, B0=>counter_11, DI1=>n23, LSR=>n235, 
    ...
    SLICE_7I: SLICE_7
      port map (A1=>counter_10, A0=>counter_9, DI0=>n26, LSR=>n235, 
                ...
                FCO=>n252);
    SLICE_8I: SLICE_8
      port map (B1=>counter_8, B0=>counter_7, FCI=>n250, F0=>n28, F1=>n27, 
                FCO=>n251);
    SLICE_9I: SLICE_9
    ...
    SLICE_12I: SLICE_12
      port map (D1=>n45, A1=>n27, D0=>n45, C0=>n28, DI1=>counter_22_N_42_8, 
                DI0=>counter_22_N_42_7, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>counter_22_N_42_7, Q0=>counter_7, F1=>counter_22_N_42_8, 
                Q1=>counter_8);
    SLICE_13I: SLICE_13
      port map (D1=>n45, B1=>n24, D0=>n45, C0=>n25, DI1=>counter_22_N_42_11, 
                DI0=>counter_22_N_42_10, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>counter_22_N_42_10, Q0=>counter_10, F1=>counter_22_N_42_11, 
                Q1=>counter_11);
    SLICE_14I: SLICE_14
      port map (D1=>n45, C1=>n19, D0=>n45, C0=>n20, DI1=>counter_22_N_42_16, 
                DI0=>counter_22_N_42_15, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>counter_22_N_42_15, Q0=>counter_15, F1=>counter_22_N_42_16, 
                Q1=>counter_16);
    SLICE_15I: SLICE_15
      port map (D1=>n16, B1=>n45, B0=>n18, A0=>n45, DI1=>counter_22_N_42_19, 
                DI0=>counter_22_N_42_17, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>counter_22_N_42_17, Q0=>counter_17, F1=>counter_22_N_42_19, 
                Q1=>counter_19);
    SLICE_16I: SLICE_16
      port map (D1=>n45, A1=>n13, D0=>n45, A0=>n15, DI1=>counter_22_N_42_22, 
                DI0=>counter_22_N_42_20, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>counter_22_N_42_20, Q0=>counter_20, F1=>counter_22_N_42_22, 
                Q1=>counter_22);
    SLICE_17I: SLICE_17
      port map (D1=>n45, A1=>led_c_1, D0=>n45, A0=>led_c_0, DI1=>led_7_N_32_1, 
                DI0=>led_7_N_32_0, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>led_7_N_32_0, Q0=>led_c_0, F1=>led_7_N_32_1, Q1=>led_c_1);
    SLICE_18I: SLICE_18
      port map (D1=>n45, A1=>led_c_3, D0=>n45, A0=>led_c_2, DI1=>led_7_N_32_3, 
                DI0=>led_7_N_32_2, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>led_7_N_32_2, Q0=>led_c_2, F1=>led_7_N_32_3, Q1=>led_c_3);
    SLICE_19I: SLICE_19
      port map (D1=>n45, A1=>led_c_5, D0=>n45, A0=>led_c_4, DI1=>led_7_N_32_5, 
                DI0=>led_7_N_32_4, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>led_7_N_32_4, Q0=>led_c_4, F1=>led_7_N_32_5, Q1=>led_c_5);
    SLICE_20I: SLICE_20
      port map (D1=>n45, A1=>led_c_7, D0=>n45, A0=>led_c_6, DI1=>led_7_N_32_7, 
                DI0=>led_7_N_32_6, LSR=>sys_rst_c, CLK=>sys_clk_c, 
                F0=>led_7_N_32_6, Q0=>led_c_6, F1=>led_7_N_32_7, Q1=>led_c_7);
    SLICE_21I: SLICE_21
      port map (D1=>n42, C1=>n36, B1=>n24_adj_4, A1=>counter_15, 
                D0=>counter_14, C0=>counter_21, B0=>counter_7, A0=>counter_9, 
                F0=>n36, F1=>n44);
    SLICE_22I: SLICE_22
      port map (D1=>n44, C1=>n31_adj_2, B1=>n40, A1=>n32_adj_1, C0=>n45, 
                A0=>sys_rst_c, F0=>n235, F1=>n45);
    SLICE_23I: SLICE_23
      port map (D1=>counter_0, C1=>n38, B1=>counter_5, A1=>n28_adj_3, 
                D0=>counter_19, C0=>counter_16, F0=>n28_adj_3, F1=>n42);
    SLICE_24I: SLICE_24
      port map (D1=>counter_6, C1=>counter_18, B1=>counter_20, A1=>counter_17, 
                D0=>counter_11, A0=>counter_10, F0=>n32_adj_1, F1=>n40);
    SLICE_25I: SLICE_25
      port map (D1=>counter_8, C1=>counter_3, B1=>counter_12, A1=>counter_4, 
                D0=>counter_2, C0=>counter_1, F0=>n31_adj_2, F1=>n38);
    SLICE_26I: SLICE_26
      port map (D0=>counter_13, B0=>counter_22, F0=>n24_adj_4);
    led_7_I: led_7_B
