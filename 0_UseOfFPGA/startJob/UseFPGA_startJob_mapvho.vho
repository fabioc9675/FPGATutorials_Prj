...
-- ldbanno -n VHDL -o UseFPGA_startJob_mapvho.vho -w -neg -gui UseFPGA_startJob_map.ncd 
-- Netlist created on Sun Dec 06 22:09:53 2020
-- Netlist written on Sun Dec 06 22:09:57 2020
  ...
  begin
    ...
    SLICE_12I: SLICE_12
      port map (A1=>n24, DI1=>n101, LSR=>n162, CLK=>clk_in_c, F1=>n101, 
                Q1=>n24, FCO=>n343);
    SLICE_13I: SLICE_13
      port map (D1=>cnt_20, C1=>cnt_18, B1=>cnt_19, A1=>n2, D0=>n9, C0=>cnt_21, 
                B0=>cnt_22, A0=>cnt_23, DI0=>led1_N_52, CLK=>clk_in_c, 
                F0=>led1_N_52, Q0=>led1_c, F1=>n9);
    SLICE_14I: SLICE_14
      port map (D1=>n14, C1=>n13_adj_3, B1=>cnt_22, A1=>cnt_14, D0=>cnt_12, 
                C0=>cnt_9, B0=>n18, A0=>n24, F0=>n13_adj_3, F1=>n14_adj_1);
    SLICE_15I: SLICE_15
      port map (D1=>n4, C1=>cnt_10, B1=>cnt_9, A1=>cnt_11, B0=>cnt_7, 
                A0=>cnt_8, F0=>n4, F1=>n359);
    SLICE_16I: SLICE_16
      port map (D1=>n14_adj_1, C1=>n13_adj_2, B1=>n381, A1=>cnt_7, D0=>cnt_16, 
                C0=>n12, B0=>cnt_21, A0=>n13, F0=>n162, F1=>n12);
    SLICE_17I: SLICE_17
      port map (D1=>cnt_14, C1=>cnt_13, B1=>n359, A1=>cnt_12, D0=>cnt_15, 
                C0=>cnt_16, B0=>cnt_17, A0=>n362, F0=>n2, F1=>n362);
    SLICE_18I: SLICE_18
      port map (C1=>cnt_20, B1=>cnt_17, A1=>cnt_15, D0=>n20, C0=>cnt_18, 
                B0=>n21, A0=>n23, F0=>n14, F1=>n13_adj_2);
    SLICE_19I: SLICE_19
      port map (D1=>cnt_13, C1=>cnt_8, B1=>cnt_10, A1=>cnt_19, D0=>cnt_23, 
                C0=>n19, B0=>cnt_11, A0=>n22, F0=>n13, F1=>n381);
    SLICE_20I: SLICE_20
      port map (A0=>led1_c, F0=>led2_c);
    led2I: led2B
