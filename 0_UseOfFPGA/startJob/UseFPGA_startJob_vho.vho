...
-- ldbanno -n VHDL -o UseFPGA_startJob_vho.vho -w -neg -gui UseFPGA_startJob.ncd 
-- Netlist created on Sun Dec 06 22:09:53 2020
-- Netlist written on Sun Dec 06 22:10:16 2020
...
-- entity SLICE_1
  ...
  begin
    cnt_23_i8: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i7: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_9: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_2
  ...
  begin
    cnt_23_i22: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i21: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_23: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_3
  ...
  begin
    cnt_23_i6: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_7: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_4
  ...
  begin
    cnt_23_i20: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i19: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_21: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_5
  ...
  begin
    cnt_23_i18: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i17: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_19: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_6
  ...
  begin
    cnt_23_i16: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i15: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_17: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_7
  ...
  begin
    cnt_23_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_5: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_8
  ...
  begin
    cnt_23_i14: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i13: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_15: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_9
  ...
  begin
    cnt_23_i12: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i11: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_13: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_10
  ...
  begin
    cnt_23_i10: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_i9: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    cnt_23_add_4_11: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_11
  ...
  begin
    cnt_23_i23: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_add_4_25: ccu20001
...
-- entity SLICE_12
  ...
  begin
    cnt_23_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    cnt_23_add_4_1: ccu20002
...
-- entity LED_shining
  ...
  entity LED_shining is
    port (clk_in: in Std_logic; rst_n_in: in Std_logic; led1: out Std_logic; 
          led2: out Std_logic);
  ...
  architecture Structure of LED_shining is
    ...
    signal n2: Std_logic;
    signal n9: Std_logic;
    signal led1_N_52: Std_logic;
    signal led1_c: Std_logic;
    signal n14: Std_logic;
    signal n13_adj_3: Std_logic;
    signal n14_adj_1: Std_logic;
    signal n4: Std_logic;
  ...
  begin
    SLICE_0I: SLICE_0
      port map (A1=>n22, A0=>n23, DI1=>n99, DI0=>n100, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n343, F0=>n100, Q0=>n23, F1=>n99, Q1=>n22, 
                FCO=>n344);
    SLICE_1I: SLICE_1
      port map (A1=>cnt_8, A0=>cnt_7, DI1=>n93, DI0=>n94, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n346, F0=>n94, Q0=>cnt_7, F1=>n93, 
                Q1=>cnt_8, FCO=>n347);
    SLICE_2I: SLICE_2
      port map (A1=>cnt_22, A0=>cnt_21, DI1=>n79, DI0=>n80, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n353, F0=>n80, Q0=>cnt_21, F1=>n79, 
                Q1=>cnt_22, FCO=>n354);
    SLICE_3I: SLICE_3
      port map (A1=>n18, A0=>n19, DI1=>n95, DI0=>n96, LSR=>n162, CLK=>clk_in_c, 
                FCI=>n345, F0=>n96, Q0=>n19, F1=>n95, Q1=>n18, FCO=>n346);
    SLICE_4I: SLICE_4
      port map (A1=>cnt_20, A0=>cnt_19, DI1=>n81, DI0=>n82, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n352, F0=>n82, Q0=>cnt_19, F1=>n81, 
                Q1=>cnt_20, FCO=>n353);
    SLICE_5I: SLICE_5
      port map (A1=>cnt_18, A0=>cnt_17, DI1=>n83, DI0=>n84, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n351, F0=>n84, Q0=>cnt_17, F1=>n83, 
                Q1=>cnt_18, FCO=>n352);
    SLICE_6I: SLICE_6
      port map (A1=>cnt_16, A0=>cnt_15, DI1=>n85, DI0=>n86, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n350, F0=>n86, Q0=>cnt_15, F1=>n85, 
                Q1=>cnt_16, FCO=>n351);
    SLICE_7I: SLICE_7
      port map (A1=>n20, A0=>n21, DI1=>n97, DI0=>n98, LSR=>n162, CLK=>clk_in_c, 
                FCI=>n344, F0=>n98, Q0=>n21, F1=>n97, Q1=>n20, FCO=>n345);
    SLICE_8I: SLICE_8
      port map (A1=>cnt_14, A0=>cnt_13, DI1=>n87, DI0=>n88, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n349, F0=>n88, Q0=>cnt_13, F1=>n87, 
                Q1=>cnt_14, FCO=>n350);
    SLICE_9I: SLICE_9
      port map (A1=>cnt_12, A0=>cnt_11, DI1=>n89, DI0=>n90, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n348, F0=>n90, Q0=>cnt_11, F1=>n89, 
                Q1=>cnt_12, FCO=>n349);
    SLICE_10I: SLICE_10
      port map (A1=>cnt_10, A0=>cnt_9, DI1=>n91, DI0=>n92, LSR=>n162, 
                CLK=>clk_in_c, FCI=>n347, F0=>n92, Q0=>cnt_9, F1=>n91, 
                Q1=>cnt_10, FCO=>n348);
    SLICE_11I: SLICE_11
      port map (A0=>cnt_23, DI0=>n78, LSR=>n162, CLK=>clk_in_c, FCI=>n354, 
                F0=>n78, Q0=>cnt_23);
    SLICE_12I: SLICE_12
      port map (A1=>n24, DI1=>n101, LSR=>n162, CLK=>clk_in_c, F1=>n101, 
                Q1=>n24, FCO=>n343);
    SLICE_13I: SLICE_13
      port map (D1=>cnt_20, C1=>cnt_18, B1=>cnt_19, A1=>n2, D0=>cnt_22, C0=>n9, 
                B0=>cnt_23, A0=>cnt_21, DI0=>led1_N_52, CLK=>clk_in_c, 
                F0=>led1_N_52, Q0=>led1_c, F1=>n9);
    SLICE_14I: SLICE_14
      port map (D1=>n14, C1=>n13_adj_3, B1=>cnt_14, A1=>cnt_22, D0=>n18, 
                C0=>cnt_9, B0=>cnt_12, A0=>n24, F0=>n13_adj_3, F1=>n14_adj_1);
    SLICE_15I: SLICE_15
      port map (D1=>cnt_11, C1=>n4, B1=>cnt_10, A1=>cnt_9, D0=>cnt_8, 
                C0=>cnt_7, F0=>n4, F1=>n359);
    SLICE_16I: SLICE_16
      port map (D1=>n13_adj_2, C1=>cnt_7, B1=>n381, A1=>n14_adj_1, D0=>n12, 
                C0=>cnt_21, B0=>n13, A0=>cnt_16, F0=>n162, F1=>n12);
    SLICE_17I: SLICE_17
      port map (D1=>n359, C1=>cnt_14, B1=>cnt_13, A1=>cnt_12, D0=>cnt_17, 
                C0=>cnt_16, B0=>n362, A0=>cnt_15, F0=>n2, F1=>n362);
    SLICE_18I: SLICE_18
      port map (D1=>cnt_20, C1=>cnt_15, B1=>cnt_17, D0=>n21, C0=>n23, 
                B0=>cnt_18, A0=>n20, F0=>n14, F1=>n13_adj_2);
    SLICE_19I: SLICE_19
      port map (D1=>cnt_13, C1=>cnt_10, B1=>cnt_19, A1=>cnt_8, D0=>cnt_11, 
                C0=>cnt_23, B0=>n22, A0=>n19, F0=>n13, F1=>n381);
    SLICE_20I: SLICE_20
      port map (B0=>led1_c, F0=>led2_c);
    led2I: led2B
      port map (PADDO=>led2_c, led2S=>led2);
    led1I: led1B
      port map (PADDO=>led1_c, led1S=>led1);
    clk_inI: clk_inB
  ...
  library IEEE, vital2000, MACHXO2;
  configuration Structure_CON of LED_shining is
    for Structure
    end for;
  end Structure_CON;
